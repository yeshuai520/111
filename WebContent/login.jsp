...
function changeImage(image){
	...
	image.src = "${pageContext.request.contextPath}/UserAction_image?hehe="+new Date();
}

$(document).ready(function(){
	
		if(window.parent != window){//自己在框架中
			//让整个框架页面编程登陆页面
            ...
            <TABLE cellSpacing=0 cellPadding=2 border=0>
              ...
              <TR>
                ...
                <TD style="HEIGHT: 28px"><INPUT id=txtcode 
                  style="WIDTH: 60px" name="code"><img src="${pageContext.request.contextPath}/UserAction_image" onclick="changeImage(this);" /></TD>
